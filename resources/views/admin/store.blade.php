...
@section('content')
   <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2 m-t-lg">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="" class="btn btn-link" data-toggle="modal" data-target=".departmentModal"><i class="fa fa-plus"></i>&nbsp;add department</a></a></li>
                    <li><a href="" class="btn btn-link" data-toggle="modal" data-target=".shelfModal"><i class="fa fa-plus"></i>&nbsp;add shelf</a></a></li>
                    <li><a href="" class="btn btn-link" data-toggle="modal" data-target=".productModal"><i class="fa fa-plus"></i>&nbsp;add product</a></a></li>
    ...
    <!-- add deparment\\ modal -->
        <div class="modal fade departmentModal">
    ...
    <!-- add shelf modal -->
        <div class="modal fade shelfModal">
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h3 class="modal-title">Add shelf</h3>
                    </div>
                    <form action="" method="post">
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="shelve name" required>
                                </div>
                            </div>
     ...
     <!-- add product modal -->
        <div class="modal fade productModal">
